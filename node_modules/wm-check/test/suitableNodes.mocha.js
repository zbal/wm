...
describe('Suitable nodes', function() {
    ...
    var check1 = new model(data_check1);
    var check2 = new model(data_check2);
    var check3 = new model(data_check3);

    it('should return 1 suitable node for check1 - 1 country', function(done) {
        check1.getSuitableNodes({
            success: function(nodes) {
                nodes.length.should.equal(1);
                nodes[0].get('id').should.equal('node2');
                setTimeout(done, 1);
            },
            error: function(err) {
